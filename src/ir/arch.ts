...
export const archs = new Map<string,ArchInfo>([
  ...
  [ "covm", {
    ...
    intSize: 4,
    registers: [
      { num: 0, name: 'R0' },   { num: 1, name: 'R1' },
      { num: 2, name: 'R2' },   { num: 3, name: 'R3' },
      { num: 4, name: 'R4' },   { num: 5, name: 'R5' },
      { num: 6, name: 'R6' },   { num: 7, name: 'R7' },
      { num: 8, name: 'R8' },   { num: 9, name: 'R9' },
      { num: 10, name: 'R10' }, { num: 11, name: 'R11' },
      { num: 12, name: 'R12' }, { num: 13, name: 'R13' },
      { num: 14, name: 'R14' }, { num: 15, name: 'R15' },
      { num: 16, name: 'F0' },  { num: 17, name: 'F1' },
      { num: 18, name: 'F2' },  { num: 19, name: 'F3' },
      { num: 20, name: 'F4' },  { num: 21, name: 'F5' },
      { num: 22, name: 'F6' },  { num: 23, name: 'F7' },
      { num: 24, name: 'F8' },  { num: 25, name: 'F9' },
      { num: 26, name: 'F10' }, { num: 27, name: 'F11' },
      { num: 28, name: 'F12' }, { num: 29, name: 'F13' },
      { num: 30, name: 'F14' }, { num: 31, name: 'F15' },
      { num: 32, name: 'SP' },  { num: 33, name: 'g' },
      { num: 34, name: 'SB' }
    ],
    hasGReg: true,
